...
export const DarkModedIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ForYouActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const MarkIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} fill="currentColor">
        <path
            fill="currentColor"
